...
import com.gpt.chatgpt.constant.OpenAIConst;
...
import com.gpt.chatgpt.sse.ConsoleEventSourceListener;
...
@Slf4j
public class OpenAiStreamClient extends AbstractClient {
    @Getter
    @NotNull
